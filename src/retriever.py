...
def create_embedding_model():
    return FastEmbedEmbeddings(
        model_name="BAAI/bge-base-en-v1.5",  # Matching your previous model
        max_length=512,  # Default token length
        normalize=True,  # Keep your previous normalization
        batch_size=256,  # Optimal batch size
        doc_embed_type="default"  # Default embedding method
    )
